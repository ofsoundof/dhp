...
class ResNeXt(nn.Module):
    def __init__(self, args):
        ...
        self.cardinality = self.args.cardinality
        self.bottleneck_width = self.args.bottleneck_width
        base = 64
        self.in_planes = base
        ...
        self.conv1 = nn.Conv2d(3, base, kernel_size=1, bias=False)
        self.bn1 = nn.BatchNorm2d(base)
        self.layer1 = self._make_layer(n, 1)
        self.layer2 = self._make_layer(n, 2)
        self.layer3 = self._make_layer(n, 2)
